sap.ui.define([
    ...
    return PluginViewController.extend("kpmg.custom.tile.dashboardKPI.dashboardKPI.controller.BaseController", {
        TileView: "kpmg.custom.tile.dashboardKPI.dashboardKPI.view.DashboardSelectionView",
        DetailView: "kpmg.custom.tile.dashboardKPI.dashboardKPI.view.KPIDashboardView",
        onInit: function(){
        ...
        navToTileView: function(){
            this.navToTargetView(this.TileView);
        },
        navToDetailView: function () {
            this.navToTargetView(this.DetailView);
        },
        ...
        getMainPodController: function(){
            let oNavContainer = this.getInfoModel().getProperty("/oNavContainer");
            let oTargetView = oNavContainer.getPages().find(function (oPage) {
                return oPage.getViewName() === this.DetailView;
            });
