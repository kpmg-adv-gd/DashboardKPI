sap.ui.define([
    ...
    return PropertyEditor.extend( "kpmg.custom.tile.dashboardKPI.dashboardKPI.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("kpmg.custom.tile.dashboardKPI.dashboardKPI.i18n.builder");
			this.setPluginResourceBundleName("kpmg.custom.tile.dashboardKPI.dashboardKPI.i18n.i18n");
		},
